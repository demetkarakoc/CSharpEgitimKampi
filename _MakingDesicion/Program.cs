...
namespace _MakingDesicion
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //if(city=="adana" | city== "ankara" | city=="bursa"| city=="antalya")
            //{
            ...
            //if(username != "admin" )
            //{
            //    Console.Write("bu kullacı adı kabul edilemez");
            //}
            //else
            //{
            ...
            #region SC Hesap Makinesi Uygulaması
